...
public class SkuDto {
	...
	private String meta_search_keywords;
	...
	public String getMeta_search_keywords() {
		return meta_search_keywords;
	}

	public void setMeta_search_keywords(String meta_search_keywords) {
		this.meta_search_keywords = meta_search_keywords;
	}
